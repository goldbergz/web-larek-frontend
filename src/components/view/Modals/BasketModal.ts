...
export class BasketModal
  ...
  private initView(): void {
    ...
    const listContainer = basketElement.querySelector<HTMLElement>('.basket__list');
    const totalPriceElement = basketElement.querySelector<HTMLElement>('.basket__price');
    const submitButton = basketElement.querySelector<HTMLButtonElement>('.basket__button');
